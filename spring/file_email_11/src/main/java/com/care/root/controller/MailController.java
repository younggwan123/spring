...
public class MailController {
	...
	public void sendMail( HttpServletResponse response ) throws Exception {
		...
		sb.append("<a href=\"https://comic.naver.com/webtoon/list?titleId=730656\">");
		...
		ms.sendMail("choheewon@hanmail.net", "광고", str  );
		//ms.sendMail("choheewon@hanmail.net","(제목)연습 메일","(내용)연습중");
